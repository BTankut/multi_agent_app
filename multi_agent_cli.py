...
def main():
    ...
    print("===============")
    print("This tool uses multiple AI models to answer your questions.")
    print("Options: free (default), paid, mixed")
    
    # Default option
    option = "free"
    
    # Process command-line arguments if provided
    if len(sys.argv) > 1 and sys.argv[1] in ["free", "paid", "mixed"]:
        option = sys.argv[1]
